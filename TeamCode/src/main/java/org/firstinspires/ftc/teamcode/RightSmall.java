...
@Autonomous(name = "AutoRightSmall", group = "Linear Opmode")
public class RightSmall extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        }else if(pos == WebcamExample.SamplePipeline.AutoPosition.LEFT){
            robot.driveController.rotateModules(Vector2d.LEFT, true, 4000, this);
